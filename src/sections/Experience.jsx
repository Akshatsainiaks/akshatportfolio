...
const Experience = () => {
  return (
    <section
      id="experience"
      className="overflow-x-hidden py-24 px-6 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white"
    >
      <div className="max-w-6xl mx-auto text-center mb-16" data-aos="fade-up">
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-cyan-400">
          Experience 📘
      ...
      <div className="relative max-w-4xl mx-auto overflow-x-hidden">
        ...
        {experiences.map((exp, index) => (
          <div
            ...
            data-aos="fade-up"
            data-aos-delay={index * 200}
            className={`mb-16 flex flex-col md:flex-row items-center md:items-start gap-6 ${
              index % 2 === 0 ? "md:flex-row-reverse" : ""
            }`}
          >
            {/* Dot */}
            <div className="relative w-full md:w-auto flex justify-center md:justify-center">
              <div className="w-6 h-6 bg-cyan-400 rounded-full border-4 border-[#0f172a] shadow-md"></div>
            </div>
